...
const animationTimeline = () => {
    ...
    // const menuju = document.getElementById("replay");
    // menuju.addEventListener("click", () => {
    //     pesanwhatsapp = "Makasii udah ngucapin " + nama + " ultah ><";
    //     window.location = "https://api.whatsapp.com/send?phone=&text=" + pesanwhatsapp;
    //      });
...
//    const holla =  document.querySelector("redirectBtn");
//    holla.addEventListener("click", redirectFunction);
...
// function nine(){wallpaper.style="transform: scale(1);";nine.style="opacity:1;transform: scale(1);";if(fungsi==2){replay.innerHTML="&#128140; Balas"}}
